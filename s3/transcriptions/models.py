...
class AudioFileChunk(base_model):
    ...
    chunk_file = models.FileField(upload_to="audio-chunks/") # Order of the chunk in the original file
    duration = models.FloatField(null=True)
...
class evaluation_results(models.Model):
        audiofilechunk = models.OneToOneField(AudioFileChunk, on_delete=models.CASCADE, related_name="evaluation_results")
