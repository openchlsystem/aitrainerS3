...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, whatsapp_number, password=None):
        ...
        user.is_active = True  # You may also set other superuser flags like is_staff, is_superuser
        user.save(using=self._db)
        return user
...
class User(AbstractBaseUser):
    ...
    first_name = models.CharField(max_length=100, null=True, blank=True)  # Add this field for name
